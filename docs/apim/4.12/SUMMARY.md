...
* [Introduction](README.md)
  ...
  * [Enterprise Edition](introduction/enterprise-edition.md)
    * [Enterprise Edition installation](introduction/enterprise-edition-installation.md)
    * [Enterprise Edition licensing](introduction/enterprise-edition-licensing.md)
  ...
  * [API Fundamentals](introduction/api-fundamentals/README.md)
    * [API Basics](introduction/api-fundamentals/api-basics.md)
    * [Web APIs](introduction/api-fundamentals/web-apis.md)
    * [Categorizing Web APIs](introduction/api-fundamentals/categorizing-web-apis.md)
...
* [Getting started](getting-started/README.md)
  ...
  * [Create & Publish Your First API](getting-started/create-and-publish-your-first-api/README.md)
    * [Create an API](getting-started/create-and-publish-your-first-api/create-an-api.md)
    * [Add Security](getting-started/create-and-publish-your-first-api/add-security.md)
    * [Add a Policy](getting-started/create-and-publish-your-first-api/add-a-policy.md)
    * [Add API Documentation](getting-started/create-and-publish-your-first-api/add-api-documentation.md)
    * [Publish your API](getting-started/create-and-publish-your-first-api/publish-your-api.md)
...
* [Self-Hosted Installation Guides](self-hosted-installation-guides/README.md)
  ...
  * [Proxy Configuration](self-hosted-installation-guides/proxy-configuration/README.md)
    * [System Proxy for Backend APIs](self-hosted-installation-guides/proxy-configuration/system-proxy-for-backend-apis.md)
* [Upgrade Guides](upgrade-guides/README.md)
  * [Upgrade APIM from 4.8.x to 4.10.x](upgrade-guides/upgrade-apim-from-4.8.x-to-4.10.x.md)
  * [Infrastructure Changes for API Product Analytics](upgrade-guides/infrastructure-changes-for-api-product-analytics.md)
...
* [How-To Guides](how-to-guides/README.md)
  * [Use Case Tutorials](how-to-guides/use-case-tutorials/README.md)
    ...
    * [Aggregating multiple responses](how-to-guides/use-case-tutorials/aggregating-multiple-responses.md)
...
* [Configure & Manage the Platform](configure-and-manage-the-platform/README.md)
  * [Gravitee Gateway](configure-and-manage-the-platform/gravitee-gateway/README.md)
    ...
    * [Span Attribute Redaction Overview](configure-and-manage-the-platform/gravitee-gateway/span-attribute-redaction-overview.md)
  ...
  * [Management API](configure-and-manage-the-platform/management-api/README.md)
    ...
    * [Native API Connection Logs Management API Reference](configure-and-manage-the-platform/management-api/native-api-connection-logs-management-api-reference.md)
...
* [Create & Configure APIs](create-and-configure-apis/README.md)
  ...
  * [Configure v4 APIs](create-and-configure-apis/configure-v4-apis/README.md)
    ...
    * [Endpoints](create-and-configure-apis/configure-v4-apis/endpoints/README.md)
      ...
      * [JMS](create-and-configure-apis/configure-v4-apis/endpoints/jms.md)
  ...
  * [Apply Policies](create-and-configure-apis/apply-policies/README.md)
    ...
    * [Policy Reference](create-and-configure-apis/apply-policies/policy-reference/README.md)
      ...
      * [JavaScript Policy (New)](create-and-configure-apis/apply-policies/policy-reference/javascript-policy-new-reference.md)
...
* [Secure & Expose APIs](secure-and-expose-apis/README.md)
  ...
  * [API Products overview and concepts](secure-and-expose-apis/api-products/README.md)
    * [API Product Analytics and Logging: Concepts and Data Model](secure-and-expose-apis/api-products/api-product-analytics-and-logging-concepts-and-data-model.md)
    * [API Product Analytics: Prerequisites and Restrictions](secure-and-expose-apis/api-products/api-product-analytics-prerequisites-and-restrictions.md)
    ...
    * [Configuring API Product Deployment with Sharding Tags](secure-and-expose-apis/api-products/configuring-api-product-deployment-with-sharding-tags.md)
...
* [Developer Portal](developer-portal/README.md)
  * [New Developer Portal](developer-portal/new-developer-portal/README.md)
    ...
    * [Customize the Navigation](developer-portal/new-developer-portal/customize-the-navigation.md)
      ...
      * [Portal automation](developer-portal/new-developer-portal/customize-the-navigation/portal-automation/README.md)
        ...
        * [API documentation](developer-portal/new-developer-portal/customize-the-navigation/portal-automation/api-documentation.md)
  ...
  * [Classic Developer Portal](developer-portal/classic-developer-portal/README.md)
    * [API Model Object Reference for Portal Templates](developer-portal/classic-developer-portal/api-model-object-reference-for-portal-templates.md)
    * [Configuration File](developer-portal/classic-developer-portal/configuration-file.md)
    * [Portal Navigation Templating Concepts](developer-portal/classic-developer-portal/portal-navigation-templating-concepts.md)
  ...
  * [Federation](govern-apis/federation/README.md)
    ...
    * [3rd-Party Providers](govern-apis/federation/3rd-party-providers/README.md)
      ...
      * [AWS API Gateway](govern-apis/federation/3rd-party-providers/aws-api-gateway/README.md)
        * [Multi-Account and Multi-Region AWS API Gateway Federation](govern-apis/federation/3rd-party-providers/aws-api-gateway/multi-account-and-multi-region-aws-api-gateway-federation.md)
        * [AWS IAM Role-Based Authentication](govern-apis/federation/3rd-party-providers/aws-api-gateway/aws-iam-role-based-authentication.md)
...
* [Analyze & Monitor APIs](analyze-and-monitor-apis/README.md)
  * [Dashboards](analyze-and-monitor-apis/dashboards/README.md)
    ...
    * [V4 Proxy API traffic dashboard](analyze-and-monitor-apis/dashboards/api-proxy-dashboard.md)
    ...
    * [LLM Usage Dashboard](analyze-and-monitor-apis/dashboards/LLM-usage-dashboard.md)
    * [MCP Usage Dashboard](analyze-and-monitor-apis/dashboards/MCP-usage-dashboard.md)
  ...
  * [Reporters](analyze-and-monitor-apis/reporters/README.md)
    ...
    * [Managing API-Specific Redaction Rules in the Console](analyze-and-monitor-apis/reporters/managing-api-specific-redaction-rules-in-the-console.md)
  ...
  * [Logging](analyze-and-monitor-apis/logging/README.md)
    ...
    * [Configure Environment-level Logs](analyze-and-monitor-apis/logging/configure-environment-level-logs.md)
    * [Configuring and Viewing Native API Connection Logs](analyze-and-monitor-apis/logging/configuring-and-viewing-native-api-connection-logs.md)
    * [Native API Connection Logs: Concepts and Architecture](analyze-and-monitor-apis/logging/native-api-connection-logs-concepts-and-architecture.md)
    * [View API Logs](analyze-and-monitor-apis/logging/view-api-logs.md)
  ...
  * [OpenTelemetry](analyze-and-monitor-apis/opentelemetry.md)
    * [OpenTelemetry Logs Integration Overview](analyze-and-monitor-apis/opentelemetry-logs-integration-overview.md)
...
* [Alert Engine](alert-engine/README.md)
  ...
  * [Install and Upgrade](alert-engine/getting-started/install-and-upgrade-guides/README.md)
    * [Sizing requirements](alert-engine/getting-started/install-and-upgrade-guides/sizing-requirements.md)
    * [Install via .ZIP file](alert-engine/getting-started/install-and-upgrade-guides/install-via-.zip-file.md)
    * [Install via Docker](alert-engine/getting-started/install-and-upgrade-guides/install-via-docker.md)
    * [Install via Kubernetes](alert-engine/getting-started/install-and-upgrade-guides/install-via-kubernetes.md)
    * [Upgrade guide](alert-engine/getting-started/install-and-upgrade-guides/upgrade-guide.md)
  * [Configuration](alert-engine/getting-started/configuration/README.md)
    * [Configure Alert Engine](alert-engine/getting-started/configuration/configure-alert-engine.md)
    * [Configure the Internal API](alert-engine/getting-started/configuration/configure-the-internal-api.md)
  * [Alerts and Conditions](alert-engine/guides/alerts-and-conditions.md)
  * [Dampening](alert-engine/guides/dampening.md)
  * [Notifications](alert-engine/guides/notifications.md)
  * [Integration set up](alert-engine/guides/integration-set-up/README.md)
    * [Gravitee API Management](alert-engine/guides/integration-set-up/gravitee-api-management/README.md)
      * [Installation](alert-engine/guides/integration-set-up/gravitee-api-management/installation.md)
      * [Configure Alerts in Gravitee API Management](configure-and-manage-the-platform/gravitee-gateway/alerts.md)
      * [Configure Notifications](alert-engine/guides/integration-set-up/gravitee-api-management/configure-notifications.md)
      * [Gravitee API Management Alerts Dashboard](alert-engine/guides/integration-set-up/gravitee-api-management/gravitee-api-management-alerts-dashboard.md)
...
* [AI Agent Management](ai-agent-management/README.md)
  ...
  * [AI Resources](ai-agent-management/AI-resources/README.md)
    ...
    * [AI - Model Text Classification - Configuration and Usage](ai-agent-management/AI-resources/ai-model-text-classification-configuration-and-usage.md)
...
* [Kafka Gateway](kafka-gateway/README.md)
  ...
  * [Expose Metrics to Elasticsearch](kafka-gateway/expose-metrics-to-elasticsearch.md)
* [Prepare a Production Environment](prepare-a-production-environment/README.md)
  ...
  * [Repositories](prepare-a-production-environment/repositories/README.md)
    * [Hazelcast Rate-Limit Repository Overview and Key Concepts](prepare-a-production-environment/repositories/hazelcast-rate-limit-repository-overview-and-key-concepts.md)
    * [Hazelcast Rate-Limit Repository Restrictions and Known Limitations](prepare-a-production-environment/repositories/hazelcast-rate-limit-repository-restrictions-and-known-limitations.md)
  ...
  * [Sensitive Data Management](prepare-a-production-environment/sensitive-data-management/README.md)
    ...
    * [API Secrets](prepare-a-production-environment/sensitive-data-management/api-secrets/README.md)
      * [Quick Start](prepare-a-production-environment/sensitive-data-management/api-secrets/quick-start.md)
...
* [Release Information](release-information/README.md)
  * [Release Notes](release-information/release-notes/README.md)
    ...
    * [APIM 4.6](https://documentation.gravitee.io/apim/4.6/overview/release-notes/apim-4.6)
  ...
  * [Changelog](release-information/changelog/README.md)
    * [APIM 4.12.x](release-information/changelog/apim-4.12.x.md)
    * [APIM 4.11.x](release-information/changelog/apim-4.11.x.md)
    * [APIM 4.10.x](https://documentation.gravitee.io/apim/4.10/release-information/changelog/apim-4.10.x)
  ...
  * [Release Types](release-information/release-types.md)
  * [Release schedule](release-information/release-schedule.md)
  * [Support Model](release-information/support-model.md)
    * [Support for v1 APIs](release-information/support-for-v1-apis.md)
